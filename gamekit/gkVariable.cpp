...
gkVariable::gkVariable(const utString& n, bool dbg)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(n),
...
gkVariable::gkVariable(bool v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(int v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(gkScalar v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(const utString& v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(const gkVector2& v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(const gkVector3& v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
gkVariable::gkVariable(const gkVector4& v, const utString& name)
	:    m_value((int)0),
	     m_type(VAR_NULL),
	     m_name(""),
	     m_debug(false), m_lock(false)
...
void gkVariable::setValue(int type, const utString& v)
{
	if (!m_lock)
	{
		m_type = type;
...
void gkVariable::setValue(const utString& v)
{
	if (!m_lock)
	{
		m_type = VAR_STRING;
...
utString gkVariable::getValueString(void) const
{
...
void gkVariable::assign(const utString& o)
{
	if (!m_lock)
	{
		m_type  = VAR_STRING;
...
void gkVariable::add(const utString& o)
{
	if (!m_lock)
	{
		gkVariable nv;
...
void gkVariable::inverse(const utString& o)
{
	if (!m_lock)
	{
		gkVariable nv;
...
void gkVariable::toggle(const utString& o)
{
	if (!m_lock)
	{
		inverse(o);
