...
GK_INLINE void gkFromString(const gkString& s, bool& v)         { v = Ogre::StringConverter::parseBool((Ogre::String)s); }
...
GK_INLINE gkString gkToString(long v)                 { return Ogre::StringConverter::toString(v); }
GK_INLINE gkString gkToString(unsigned long v)       { return Ogre::StringConverter::toString(v); }
